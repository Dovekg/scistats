<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            @if($task->data_file)
                <td>
                    <a href="{{ route('download', $task->data_file) }}" class="btn btn-success btn-xs"><i class="fa fa-cloud-download"></i>下载数据文档</a>
                </td>
            @elseif($task->review_file)
                <td><a href="{{ route('download',$task->data_file) }}" class="btn btn-success btn-xs"><i class="fa fa-cloud-download"></i>下载数据文档</a></td>
            @else
                <td>
        ...
        <tr>
            ...
            @if($task->result_file)
                <td>
                    <a href="{{ route('download',$task->result_file) }}" class="btn btn-success btn-xs"><i class="fa fa-cloud-download"></i>下载结果文档</a>
                </td>
            @else
                <td>
